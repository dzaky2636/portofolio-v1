        ...
        <div className="space-y-10">
          {projects.map((project) => (
            <div
              ...
              className="bg-white border-4 border-black shadow-[8px_8px_0px_#0C0C0C] p-8 md:p-10 hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[6px_6px_0px_#0C0C0C] hover:border-[#2945FF] transition-all duration-75 cursor-pointer rounded-none"
              role="button"
              tabIndex={0}
              onKeyDown={(e) => {
